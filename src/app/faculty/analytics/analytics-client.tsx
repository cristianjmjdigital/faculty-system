  ...
  return (
    <div className="section-shell space-y-8 fade-in">
      <header className="space-y-1">
        ...
        <h1 className="mt-2 text-2xl font-bold text-ink">Data Graphs &amp; Recommendation</h1>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="card glass">
              <div className="card-header">
                <h2 className="text-base font-semibold text-ink">Category Performance</h2>
              </div>
            ...
            {sentimentData.length > 0 && (
              <div className="card glass">
                <div className="card-header">
                  <h2 className="text-base font-semibold text-ink">Sentiment Distribution</h2>
                </div>
                <div className="card-body">
            ...
            {roleData.length >= 2 && (
              <div className="card glass">
                <div className="card-header">
                  <h2 className="text-base font-semibold text-ink">Evaluation by Role</h2>
                </div>
                <div className="card-body">
                  <div className="h-72">
                    <ResponsiveContainer width="100%" height="100%">
                      <RadarChart data={roleData} cx="50%" cy="50%" outerRadius="70%">
                        ...
                        <PolarAngleAxis dataKey="role" tick={{ fill: "#64748b", fontSize: 12 }} />
            ...
            {evaluatorData.length > 1 && (
              <div className="card glass">
                <div className="card-header">
                  <h2 className="text-base font-semibold text-ink">Evaluator Comparison</h2>
                </div>
                <div className="card-body">
                  <div className="h-72">
                    <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="card glass">
            ...
            <div className="card-body space-y-3">
              {recommendations.map((rec, i) => (
                <div key={i} className="flex gap-3 rounded-xl bg-slate-50 border border-slate-200 p-4">
