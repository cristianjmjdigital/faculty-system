  ...
  return (
    <form className="space-y-6" onSubmit={handleSubmit}>
      ...
      <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm text-slate-800">
        ...
        <div className="mt-3 grid grid-cols-5 gap-2 text-center text-xs font-semibold text-slate-700">
          <div className="rounded-md bg-white p-2 shadow-sm">
            <p>5</p>
            <p className="text-[11px] font-normal text-slate-600">Outstanding</p>
          </div>
          <div className="rounded-md bg-white p-2 shadow-sm">
            <p>4</p>
            <p className="text-[11px] font-normal text-slate-600">Very Satisfactory</p>
          </div>
          <div className="rounded-md bg-white p-2 shadow-sm">
            <p>3</p>
            <p className="text-[11px] font-normal text-slate-600">Satisfactory</p>
          </div>
          <div className="rounded-md bg-white p-2 shadow-sm">
            <p>2</p>
            <p className="text-[11px] font-normal text-slate-600">Fair</p>
          </div>
          <div className="rounded-md bg-white p-2 shadow-sm">
            <p>1</p>
            <p className="text-[11px] font-normal text-slate-600">Poor</p>
          </div>
        </div>
      </div>
            ...
            <div key={cat.id} className="rounded-xl border border-slate-200 bg-white shadow-sm">
              <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 px-4 py-3">
                <div>
                  ...
                  {cat.description ? <p className="text-xs text-slate-600">{cat.description}</p> : null}
                </div>
                {totals ? (
