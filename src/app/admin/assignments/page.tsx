      ...
      <div className="section-shell space-y-8">
        <header className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-bold text-ink">Evaluator assignments</h1>
            <p className="text-slate-600 text-sm mt-1">Assign evaluators to faculty members for specific evaluation periods.</p>
          </div>
        ...
        <div className="card glass">
          <div className="card-header">
            <div>
                ...
                <h2 className="text-lg font-semibold text-ink">Manage evaluator assignments</h2>
            </div>
          </div>
